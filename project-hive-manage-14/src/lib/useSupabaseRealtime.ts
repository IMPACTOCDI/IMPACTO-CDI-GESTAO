...
import { RealtimePostgresChangesPayload, RealtimeChannel, RealtimeChannelSendResponse, RealtimePostgresInsertPayload, RealtimePostgresUpdatePayload, RealtimePostgresDeletePayload } from '@supabase/supabase-js';
...
export const useSupabaseRealtime = (channelName: string, options: SubscriptionOptions) => {
  ...
  const setupSubscription = useCallback(() => {
    ...
    try {
      ...
      const realtimeChannel = channel as unknown as RealtimeChannel;
      realtimeChannel
